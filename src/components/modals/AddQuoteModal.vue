<template>
  <div class="absolute z-10 top-[-6rem]">
    <div
      class="flex items-start min-h-screen min-w-screen sm:items-center justify-center text-center sm:p-0"
    >
      <div class="relative bg-[#11101A] rounded-lg text-left max-w-7xl md:p-20">
        ...
        <div class="sm:flex sm:items-start">
          <div class="text-center">
            ...
            <div class="border border-b-0 opacity-25 text-[#EFEFEF] mt-4"></div>
